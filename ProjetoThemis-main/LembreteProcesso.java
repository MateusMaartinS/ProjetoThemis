    ...
    //Metodos
        ...
        if (lembretes.isEmpty()) {
            ...
            for (LembreteProcesso lembrete : lembretes) {   
                ...
                System.out.println(String.format("Seu proceso numero %d está marcada para data: %s", lembrete.numAudiencia, lembrete.dataAudiencia));
                System.out.println(String.format("O local da sua audiência no tribunal %s na vara %s no Órgão Judicial %s ",lembrete.tribunal, lembrete.vara, lembrete.orgaoJudicial));
                System.out.println(String.format("O cliente %s será defendido pelo advogado %s", lembrete.nomeEmpregador, lembrete.nomeAdvogado));
                System.out.println(String.format("O status da audiência é %s", lembrete.status));
            }}
